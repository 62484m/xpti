...
export default function Result({ scores, onRestart }: ResultProps) {
  ...
  const waifu = useMemo(() => {
    ...
    const waifus: Record<string, { name: string, imageUrl: string, taobaoUrl: string, desc: string }> = {
      'DVP': { 
        name: '纯情小女仆', 
        imageUrl: '/images/1.png', // 替换为你上传的图片名
      ...
      'DVN': { 
        name: '病娇小恶魔', 
        imageUrl: '/images/2.png', // 替换为你上传的图片名
      ...
      'DEP': { 
        name: '温柔青梅竹马', 
        imageUrl: '/images/3.png', // 替换为你上传的图片名
      ...
      'SEN': { 
        name: '腹黑魔女', 
        imageUrl: '/images/8.png', // 替换为你上传的图片名
